 ...
 * @property HistoryEditStok[] $historyEditStoks
...
class StokBarang extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['jumlah_stok'], 'default', 'value' => 0],
            [['id_barang', 'id_outlet'], 'required'],
            [['id_barang', 'jumlah_stok', 'id_outlet'], 'integer'],
    ...
    /**
     * Gets query for [[HistoryEditStoks]].
     *
     * @return \yii\db\ActiveQuery
     */
    public function getHistoryEditStoks()
    {
        return $this->hasMany(HistoryEditStok::class, ['id_stok_barang' => 'id']);
    }
